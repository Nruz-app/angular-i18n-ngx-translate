...
# Paso 3: Evita que Puppeteer descargue su propio Chromium (NO Testing)
...
# Paso 6: Instala Chromium y dependencias del sistema (NO Testing)
...
# Paso 7: Configuración para que Puppeteer/Karma use el Chromium del sistema (NO Testing)
#ENV CHROME_BIN=/usr/bin/chromium

# Paso 8: Copia el resto del código fuente
COPY . .

# Paso 9: Ejecuta tests (NO Testing)
...
COPY --from=build /app/dist/i18n-app/browser /usr/share/nginx/html
